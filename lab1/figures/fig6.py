...
ax[1].plot(acTimes[2048-100:2048+100],np.fft.fftshift(invPowerSpectrum)[2048-100:2048+100], label = "IFT", ls = "-", marker= ".", color = "#0d265c")
ax[1].plot(acTimes[2048-100:2048+100],npACF[2048-100:2048+100], label = "numpy", ls = "-", marker = ".", color = "#ffa600")
...
ax[0].set_xticks(np.arange(-0.8,0.81,0.2))
ax[0].set_ylim(-1500,1500)
ax[0].set_yticks(np.arange(-1500,1501,500))
...
'''
plt.tight_layout()
plt.savefig("../images/autoCorrelate.png")
