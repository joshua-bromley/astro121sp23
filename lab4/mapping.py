...
img = ax.imshow(tempGrid, cmap = "jet", extent = [160,221,-70,-12], transform = ccrs.PlateCarree(), origin = "lower")
...
ax = fig.add_subplot(1,1,1,projection = ccrs.Mollweide(central_longitude=180))
img = ax.imshow(vGrid*1e-3, cmap = "RdBu_r", extent = [160,221,-70,-12], transform = ccrs.PlateCarree(), origin = "lower")
...
ax = fig.add_subplot(1,1,1,projection = ccrs.Mollweide(central_longitude=180))
img = ax.imshow(sigmaGrid*1e-3, cmap = "jet", extent = [160,221,-70,-12], transform = ccrs.PlateCarree(), origin = "lower")
ax.set_extent([160,221,-70,-12], crs = ccrs.PlateCarree())
ax.gridlines( draw_labels = True, x_inline = False, y_inline = False)
ax.set_xlabel("$\ell$", fontsize = 25)
ax.set_ylabel("$b$", fontsize = 25)
